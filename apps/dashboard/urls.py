...
urlpatterns = [
    ...
    path('verification/queue/', views.manual_verification_queue_view),
    path('verification/', views.manual_verification_queue_view),
    path('verification-queue/bulk-action/', views.verification_bulk_action_view, name='dashboard-verification-bulk-action'),
    path('verification/queue/bulk-action/', views.verification_bulk_action_view),
    path('verification-queue/<int:verification_id>/action/', views.verification_action_view, name='dashboard-verification-action'),
    path('verification/queue/<int:verification_id>/action/', views.verification_action_view),
    ...
    path('verification/proof/<str:order_code>/', views.view_payment_proof_image, name='dashboard-verification-proof-image'),
    path('registrations/', views.registrations_list_view, name='dashboard-registrations-list'),
    path('registrations/bulk-action/', views.registration_bulk_action_view, name='dashboard-registration-bulk-action'),
    path('registrations/<str:registration_code>/status-change/', views.change_registration_status_view, name='dashboard-registration-status-change'),
    ...
    path('database/', views.database_view, name='dashboard-database'),
    path('database/export-csv/', views.export_customers_csv, name='dashboard-database-export-csv'),
